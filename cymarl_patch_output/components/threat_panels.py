...
def render_ioc_panel(state: dict):
    ...
    if not ioc_df.empty:
        ...
        display_order = [
            ...
            "Destination",   # FIX #16: actual attack path destination
            "Ports",
        ...
        # FIX #15: Source truncation limit increased to show full source paths
        # FIX #16: Destination not truncated since it's a short asset name
        trunc_map = {
            "IOC": 60,
            "Asset": 40,       # FIX #14: wider to show full asset names
            "Source": 50,      # FIX #15: wider (was 30)
            "Destination": 40, # FIX #16: wider
            "Evidence": 80,
        }
        ...
        if "Confidence" in display_df.columns:
            column_config["Confidence"] = st.column_config.NumberColumn("Confidence", width="small")
        ...
        if "Destination" in display_df.columns:
            column_config["Destination"] = st.column_config.TextColumn("Destination", width="medium")  # FIX #16
